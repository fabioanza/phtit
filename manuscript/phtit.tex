...
\end{equation}
The divergence operator can be computed, in arbitrary coordinates $\xi^j$, using the Voss-Weyl formula: 
$\nabla \cdot \vec{V} = \frac{1}{\sqrt{\mathrm{det}g}} \frac{\partial}{\partial \xi^i} \left( \sqrt{\mathrm{det}g} g^{ij}\frac{\partial}{\partial \xi^j}\right) $
