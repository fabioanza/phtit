...
% What is a Quantum State?
Kinetic theory for quantum information transport
}

\def\ourAbstract{%
We propose a novel theoretical framework aimed at studying and understanding how generic open quantum 
...
\author{Fabio Anza}
\email{fabio.anza@units.it}

%\author{James P. Crutchfield}
%\email{chaos@ucdavis.edu}
\affiliation{Department of Mathematics and Geoscience, University of Trieste, Via Weiss 2, Trieste, 34128, Italy}
...
\begin{itemize}
\item Why state space structure is important
\item Emerging patterns perspective
\end{itemize}
...
studying the dynamics of non-linear systems \cite{Ruelle}. We leverage Geometric Quantum Mechanics (GQM): 
...
E_j = \mathbb{I}$. In GQM they consist of nonnegative hermitian forms $E_j(Z)\ge
...
\paragraph*{Geometric Quantum States and Conditional Ensembles.}
